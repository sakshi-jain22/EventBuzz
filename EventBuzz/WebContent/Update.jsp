...
<%@ page import="com.eventBuzz.Genuine.Students" %>
	...
	%>
                ...
                <form class="form-horizontal" action="Update" method="post">
                    <input type="hidden" class="form-control" name="eno" placeholder="Enter the enrollment no." value="<%= student.getEnroll() %>">
                    <table align="center">
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="S_nm" placeholder="Enter the Name" value="<%= student.getName() %>">
                                    </div>
                                </td>
                        ...
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="U_nm" placeholder="Enter a username" value="<%= student.username %>">
                                    </div>
                                </td>
                        ...
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <div class="col-sm-12">
                                        <input type="email" class="form-control" name="email" placeholder="Enter your Email" value="<%= student.getMail() %>">
                                    </div>
                                </td>
                        ...
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <div class="col-sm-12">
                                        <input type="password" class="form-control" name="password" placeholder="Enter the password" value="<%= student.getPassword() %>">
                                    </div>
                                </td>
                        ...
                        <tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
                                <td>
                                    <div class="col-sm-12">
                                        <input type="password" class="form-control" name="C_password" placeholder=" Re-enter the Password" value="<%= student.getPassword() %>">
                                    </div>
                                </td>
                                <td><i class="fa fa-key" aria-hidden="true"></i></td>
                            </div>
                        ...
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="P_No" placeholder="Enter Phone No" value="<%= student.getPhoneNumber() %>">
                                    </div>
                                </td>
                        ...
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="C_name" placeholder="Enter CollegeName" value="<%= student.getClg() %>">
                                    </div>
                                </td>
                            ...
                            <div class="form-group">
                                <td colspan=2 align="center">
                                    <div class="col-sm-12">
                                        ...
                                        <button type="reset" class="btn-danger">&nbsp;Refresh&nbsp;</button>
                                    </div>
                                </td>
                                <td>
                                    <button type="submit" class="btn-info" formaction="myprofile.jsp">&nbsp;Back&nbsp;</button>
                                </td>
                            </div>
                        </tr>
